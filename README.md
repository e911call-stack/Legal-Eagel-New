# LEXORA — Legal Accountability Platform
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/YOUR_REPO/lexora)
...
### 1. Clone & install
```bash
git clone https://github.com/YOUR_REPO/lexora
cd lexora
npm install
```
